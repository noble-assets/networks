module github.com/noble-assets/networks/testnet/grand-rehearsal-1/e2e

go 1.21

require (
	github.com/strangelove-ventures/interchaintest/v4 v4.0.0-20231117221144-b7b2812c44c7
